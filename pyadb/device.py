...
def main():
    for d in get_devices():
        ...
        print(parse_mac(d, mac_str='d8:9b:3b:6d:71:a5'))
        print(parse_mac(d, mac_str='d8:9b:3b:6d:72:c4'))
        print(parse_mac(d, mac_str='88:f5:6e:06:6d:7a'))
        print(parse_mac(d, mac_str='70:3a:51:88:f3:91'))
        print(parse_mac(d, mac_str='80:ad:16:5d:58:38'))
        print(parse_mac(d, mac_str='24:79:f3:a5:ef:31'))
        print(parse_mac(d, mac_str='c0:2e:25:da:a4:8f'))
        # print(get_ip(d))
        # print(get_ip(d))
        # print(get_ip(d))
        # print(get_ip(d))
